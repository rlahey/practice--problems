...
let startingBalance = parseInt(prompt("Welcome to our banking app! Please enter your starting balance."));
...
let newBalance;
    if(depositMessage){
        depositAmount = parseInt(prompt(`Please enter how much you would like to deposit`))
            newBalance = startingBalance + depositAmt;
            console.log(`Your new balance is ${newBalance}`);


        while(depositAmt < 0 || isNaN(depositAmt)){
            depositMessage = parseInt(prompt(`Please enter a positive number only`));
